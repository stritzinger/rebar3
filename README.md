...
| Templates            | Configurable templates ship out of the box (use `rebar new --list` for a list or `rebar new <template> --help` for details). [Custom templates](https://rebar3.org/docs/tutorials/templates) are also supported, and plugins can also add their own.                                                                                                 |
