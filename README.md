...
| Shell                | A full shell with your applications available can be started with `rebar shell`. From there, call tasks as `r3:do(compile)` to automatically recompile and reload the code without interruption                                                                                                                                                         |
