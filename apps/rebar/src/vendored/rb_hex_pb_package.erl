...
source_basename() -> "rb_hex_pb_package.proto".
...
get_all_source_basenames() -> ["rb_hex_pb_package.proto"].
...
%% functions.
get_all_proto_names() -> ["rb_hex_pb_package"].


get_msg_containment("rb_hex_pb_package") -> ['Dependency', 'Package', 'Release', 'RetirementStatus'];
...
get_enum_containment("rb_hex_pb_package") -> ['RetirementReason'];
